(function (global, factory) {
  ...
  var PlayerWrapper = function PlayerWrapper(
    ...
    if (!this.vjsPlayer.ads) {
      window.console.warn(
        "You may be using a version of videojs-contrib-ads " +
  ...
  var Controller = function Controller(player, options) {
    ...
    var adsPluginSettings = Object.assign(
      {},
      contribAdsDefaults,
   ...
   */
  var PlayerWrapper$2 = function PlayerWrapper(
    player,
    adsPluginSettings,
    daiController
  ) {
  ...
  SdkImpl$2.prototype.onAddTrack = function (event) {
    ...
    if (track.kind === "metadata") {
      ...
      track.oncuechange = function (e) {
        ...
        try {
          for (
            var _iterator = track.activeCues_[Symbol.iterator](), _step;
